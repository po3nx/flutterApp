import 'package:myapp/pages/ui_view/body_measurement.dart';
import 'package:myapp/pages/ui_view/glass_view.dart';
import 'package:myapp/pages/ui_view/mediterranean_diet_view.dart';
import 'package:myapp/pages/ui_view/title_view.dart';
import 'package:myapp/app_theme.dart';
import 'package:myapp/pages/my_diary/meals_list_view.dart';
import 'package:myapp/pages/my_diary/water_view.dart';
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Expanded(
                              child: Padding(
                                padding: const EdgeInsets.only(left: 56.0, top: 8.0, right: 8.0, bottom: 8.0),
                                child: Text(
                                  'My Diary',
